            ...
            return (
                <ScrollView style={{flex: 1, backgroundColor: '#ffffff'}}
                    ...
                    <View style={{backgroundColor: 'white', height: 56, width: Dimensions.get('window').width}}>
                        <TouchableNativeFeedback onPress={this.changeScreen.bind(this, 'Register')}
                    ...
                    <Text style={{
                        ...
                        marginTop: 10,
                        marginBottom: 16
                    }}>OTP sent on your registered mobile number.</Text>
                    <View style={{flex: 1, flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                        <View style={styles.inputFieldView}>
                            <TextInput onChangeText={(otp) => this.setState({otp})} keyboardType="numeric"
                                       style={styles.inputField} placeholder={'Enter OTP'}
                    ...
                    <TouchableOpacity onPress={this.handleNext}
                        ...
                        <View style={{
                            ...
                            <Text style={{color: colors.teal, fontFamily: 'Montserrat-Regular', fontSize: 22}}>Submit
                                OTP</Text>
                        </View>
                    </TouchableOpacity>
                    {this.state.loggingIn ? <ActivityIndicator animating={true} style={{marginTop: 12}} size={'small'}
