    ...
    render() {
        ...
        if (this.state.value == 'Home') {
            return (<View style={{flex: 1, backgroundColor: '#ffffff', justifyContent: 'center', alignItems: 'center'}}>
                    ...
                    <Text
                        style={{color: colors.teal, fontFamily: 'Montserrat-Medium', fontSize: 22}}>#Pecfest2018</Text>
                    <Text style={{
                        color: colors.teal,
                        ...
                        marginBottom: 16,
                        textAlign: 'center'
                    }}>Please Login or Sign Up and be a part of the Pecfest family.</Text>
                    <TouchableOpacity onPress={this.changeScreen.bind(this, 'Login')}
                    ...
                    <TouchableOpacity onPress={this.changeScreen.bind(this, 'Register')}
                                      background={TouchableNativeFeedback.Ripple(colors.teal, true)}>
                        <View style={{
                            marginLeft: 16,
                            marginRight: 16,
                            ...
                            <Text style={{color: colors.teal, fontFamily: 'Montserrat-Regular', fontSize: 22}}>Sign
                                Up</Text>
                        </View>
                    </TouchableOpacity>
                </View>
