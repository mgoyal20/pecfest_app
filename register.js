                ...
                <View style={{flex: 1, backgroundColor: '#ffffff', justifyContent: 'center', alignItems: 'center'}}>
                    ...
                    <ScrollView style={{flex: 1, backgroundColor: '#ffffff'}}
                        ...
                        <View style={styles.inputFieldView}>
                            <TextInput onChangeText={(fName) => this.setState({fName})} style={styles.inputField}
                        ...
                        <View style={styles.inputFieldView}>
                            <TextInput onChangeText={(lName) => this.setState({lName})} style={styles.inputField}
                                       placeholder={'Last Name'}
                                       underlineColorAndroid={'white'} autoCapitalize={'words'}
                                       blurOnSubmit={false}
                                       selectionColor={colors.teal}
                                       onSubmitEditing={() => {
                        ...
                        <ScrollView scrollEnabled={false} contentContainerStyle={styles.inputFieldView}>
                            <Picker selectedValue={this.state.accomodation}
                                    onValueChange={(itemValue) => this.setState({accomodation: itemValue})}
                                    style={styles.pickerField} mode={'dropdown'}
