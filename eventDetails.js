...
export default class EventDetails extends Component {
    ...
    FirstRoute = () => (
        <ScrollView style={styles.scrollContainer}>
            ...
            <Text style={{
                ...
                marginBottom: 0
            }}>{this.props.event.prize.split(';').join('\n')}</Text>
            <Text style={{
                fontFamily: 'Montserrat-Regular',
                color: colors.teal,
                fontSize: 22,
            ...
            <Text style={{
                ...
                borderColor: colors.teal,
                marginBottom: 16
            }}>{this.props.event.location} on Day {this.props.event.day} @ {this.props.event.time}</Text>
            <View style={{
            ...
            <TouchableWithoutFeedback onPress={this.changeIndex.bind(this, 1)}
        ...
        if (global.loggedIn) {
            ...
            return (
                <View style={{flex: 1, backgroundColor: 'white', justifyContent: 'center', alignItems: 'center'}}>
                    <Image source={require('./icons/block.png')}
                           style={{tintColor: 'rgba(0,0,0,0.5)', height: 50, width: 50, marginBottom: 8}}/>
                    <Text style={{fontFamily: 'Montserrat-Medium', fontSize: 12, color: 'rgba(0,0,0,0.5)'}}>Please login
                        to register.</Text>
                </View>
            )
        }
    ...
    ThirdRoute = () => (
        <ScrollView style={styles.scrollContainer} contentContainerStyle={{alignItems: 'center'}}>
            ...
            <Text style={{color: colors.teal, fontFamily: 'Montserrat-Regular', fontSize: 12, marginBottom: 16}}>Feel
                free to contact for any queries.</Text>
    ...
    _renderIcon = ({route}) => {
        if (route.key == 1) {
            return (
                <Image source={require('./icons/ic_home_36pt.png')}
                       style={[styles.tabIcon, {tintColor: (this.state.message == 'Home') ? colors.selected : '#ffffff'}]}/>
            );
        }
        if (route.key == 2) {
            return (
                <Image source={require('./icons/register.png')}
                       style={[styles.tabIcon, {tintColor: (this.state.message == 'Home') ? colors.selected : '#ffffff'}]}/>
            );
        }
        if (route.key == 3) {
            return (
                <Image source={require('./icons/ic_contacts.png')}
                       style={[styles.tabIcon, {tintColor: (this.state.message == 'Home') ? colors.selected : '#ffffff'}]}/>
            );
        }
    ...
    _renderHeader = props => {
        return (
            <TabBar {...props} scrollEnabled style={styles.tabBarStyle} renderIcon={this._renderIcon}
                    indicatorStyle={styles.indicator} tabStyle={styles.tab}/>
        )
    }
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <View style={styles.navBar}>
                    <TouchableNativeFeedback onPress={this.handleBack.bind(this, 'true')}
