            ...
            <View style={{flex: 1, backgroundColor: '#ffffff', alignItems: 'center', justifyContent: 'center'}}>
                ...
                <View style={{
                    ...
                    <View style={{alignItems: 'center', marginRight: 0}}>
                        <Image source={require('./developers/harman.png')}
                               style={{height: size, width: size, borderRadius: 100, marginRight: 0}}/>
                        <Text
                            style={{fontFamily: 'Montserrat-Regular', color: colors.normal, fontSize: 16}}>Harman</Text>
                ...
                <View style={{
                    ...
                    <View style={{alignItems: 'center', marginRight: 0}}>
                        <Image source={require('./developers/prince.png')}
                               style={{height: size, width: size, borderRadius: 100, marginRight: 0}}/>
                        <Text style={{
                    ...
                    <View style={{alignItems: 'center', marginRight: 0}}>
                        <Image source={require('./developers/bindal.png')}
                               style={{height: size, width: size, borderRadius: 100, marginRight: 0}}/>
                        <Text
                            style={{fontFamily: 'Montserrat-Regular', color: colors.normal, fontSize: 16}}>Ankit</Text>
                        {/*<View style={{flexDirection: 'row'}}>
                      <TouchableWithoutFeedback onPress={() => {Linking.openURL('https://www.facebook.com/pecfestofficial')}}>
                          <Image source={require('./icons/facebook.png')} style={{marginLeft:4, marginRight: 4, width: 24, height: 24, tintColor: colors.teal}} />
                      </TouchableWithoutFeedback>
                    ...
                    <View style={{alignItems: 'center', marginLeft: 0}}>
                        <Image source={require('./developers/mitesh.png')}
                               style={{height: size, width: size, borderRadius: 100, marginRight: 0}}/>
                        <Text
                            style={{fontFamily: 'Montserrat-Regular', color: colors.normal, fontSize: 16}}>Mitesh</Text>
                        {/*<View style={{flexDirection: 'row'}}>
                      <TouchableWithoutFeedback onPress={() => {Linking.openURL('https://www.facebook.com/pecfestofficial')}}>
                          <Image source={require('./icons/facebook.png')} style={{marginLeft:4, marginRight: 4, width: 24, height: 24, tintColor: colors.teal}} />
                      </TouchableWithoutFeedback>
