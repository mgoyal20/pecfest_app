...
export default class TeamMemberCard extends Component {
    ...
    render() {
        ...
        return (
            <TouchableNativeFeedback onPress={() => Communications.phonecall(this.props.phone, true)}
                                     background={TouchableNativeFeedback.Ripple(colors.teal, false)}
                                     useForeground={true}>
                <ImageBackground source={{uri: 'http://assets.pecfest.in/team/team_' + this.props.photo + '.jpg'}}
                                 style={{
                                     alignItems: 'center',
